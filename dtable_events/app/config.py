...
CLEAN_DB_KEEP_EMAIL_SENDING_LOG_DAYS = configs.get('CLEAN_DB_KEEP_EMAIL_SENDING_LOG_DAYS', default=60)
CLEAN_DB_KEEP_SYSADMIN_EXTRA_USERLOGINLOG_DAYS = configs.get('CLEAN_DB_KEEP_SYSADMIN_EXTRA_USERLOGINLOG_DAYS', default=60)
