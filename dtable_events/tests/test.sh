...
export PYTHONPATH="/usr/local/lib/python3.12/site-packages:/usr/local/lib/python3.12/dist-packages:/usr/lib/python3.12/site-packages:/usr/lib/python3.12/dist-packages:/tmp/seafobj:${PYTHONPATH}"
cd "$EVENTS_SRCDIR"
set +x
