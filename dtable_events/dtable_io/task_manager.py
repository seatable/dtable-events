...
class TaskManager(object):
    ...
    def insert_page_to_row(self,dtable_uuid, page_id, row_id, access_token, session_id, target_table_name, target_row_id, target_column_name, file_name, server_url):
