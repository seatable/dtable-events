...
from dtable_events.utils import get_opt_from_conf_or_env, parse_bool, uuid_str_to_36_chars, set_job_timeout
...
class DataSyncerTimer(Thread):
    ...
    def run(self):
        ...
        @sched.scheduled_job('cron', day_of_week='*', hour='*', minute='30', misfire_grace_time=300)
